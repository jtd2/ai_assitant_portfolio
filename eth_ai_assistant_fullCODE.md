...
if chunks and index:
    ...
    print("❌ RAG not initialized. Cache files missing.")

# --- Telegram Bot Handlers ---
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "Welcome to the Ethereum Builder Docs Chatbot.\nType a question to get started or type /help."
    )
...
async def prompting_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "💡 Prompting Tips:\nBe specific when asking about smart contracts or Ethereum internals.\n"
        "E.g., 'What are best practices for setting environment variables in Solidity?'"
    )
